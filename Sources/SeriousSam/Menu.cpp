...
CTString astrLensFlaresQualityTexts[] =
{
  RADIOTRANS("None"),
  RADIOTRANS("Corona"),
...
CTString astrLensFlaresQualityValues[] =
{
  "0",
  "1",
  "2",
...
void InitializeMenus(void)
{
  ...
  try
  {
    ...
    TRANSLATERADIOARRAY(astrLensFlaresQualityTexts);
...
void CRenderingOptionsMenu::Initialize_t(void)
{
  ...
  mgRenderingOptionsLensFlaresQuality.mg_astrTexts = astrLensFlaresQualityTexts;
  mgRenderingOptionsLensFlaresQuality.mg_ctTexts = ARRAYCOUNT(astrLensFlaresQualityTexts);
  ...
  mgRenderingOptionsLensFlaresQuality.mg_strValue = astrLensFlaresQualityTexts[0];
...
void CAdvRenderingOptionsMenu::Initialize_t(void)
{
  ...
  mgAdvRenderingOptionsCrosshairOpacity.mg_strTip = mgAdvRenderingOptionsHUDOpacity.mg_pvsVar->vs_strTip;
  ...
  for (INDEX i = 0; i < ctTexts; i++)
  {
    mgAdvRenderingOptionsHUDOpacity.mg_pvsVar->vs_astrTexts[i] = astrCrosshairOpacityTexts[i];
    mgAdvRenderingOptionsHUDOpacity.mg_pvsVar->vs_astrValues[i] = astrCrosshairOpacityValues[i];
  }
  ...
  ctTexts = ARRAYCOUNT(astrLensFlaresQualityTexts);
  ...
  for (INDEX i = 0; i < ctTexts; i++)
  {
    mgAdvRenderingOptionsLensFlaresQuality.mg_pvsVar->vs_astrTexts[i] = astrLensFlaresQualityTexts[i];
    mgAdvRenderingOptionsLensFlaresQuality.mg_pvsVar->vs_astrValues[i] = astrLensFlaresQualityValues[i];
  }
  ...
  mgAdvRenderingOptionsArrowUp.mg_boxOnScreen = BoxArrow(3.11f);
