...
void CMainMenu::Initialize_t(void)
{
  // intialize main menu
    ...
    mgMainNewGame.mg_boxOnScreen = BoxBigRow(5.5f);
    ...
    mgMainLoadGame.mg_boxOnScreen = BoxBigRow(6.5f);
    ...
    mgMainOptions.mg_boxOnScreen = BoxBigRow(7.5f);
    ...
    mgMainCredits.mg_boxOnScreen = BoxBigRow(8.5f);
    ...
    mgMainQuitGame.mg_boxOnScreen = BoxBigRow(9.5f);
    mgMainQuitGame.mg_strTip = TRANS("Exit game immediately");
